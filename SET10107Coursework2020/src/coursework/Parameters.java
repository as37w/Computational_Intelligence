...
public class Parameters {
	...
	public static double crossoverProbability = 1; //Chance of crossover occurring
	public static int tournamentSize = 10; //Number of participants in tournament selection
